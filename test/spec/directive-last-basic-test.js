...
describe('Last step directive with basic conf', function() {
    ...
    describe('without template', function() {
        ...
        beforeEach(inject(function($rootScope, $compile) {
            var elem = angular.element('<span ncy-breadcrumb-last></span><div ui-view></div>');
    ...
    describe('with template', function() {
        ...
        beforeEach(inject(function($rootScope, $compile) {
            var elem = angular.element('<span ncy-breadcrumb-last="{{ncyBreadcrumbLabel}}|{{ncyBreadcrumbLink}}"></span><div ui-view></div>');
            element = $compile(elem)($rootScope.$new());
        }));
