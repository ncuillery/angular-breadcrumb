...
describe('Text directive with basic conf', function() {
    ...
    describe('without template', function() {
        ...
        beforeEach(inject(function($rootScope, $compile) {
            var elem = angular.element('<span ncy-breadcrumb-text></span><div ui-view></div>');
    ...
    describe('with template', function() {
        ...
        beforeEach(inject(function($rootScope, $compile) {
            var elem = angular.element('<span ncy-breadcrumb-text="{{ncyBreadcrumbChain}} - MyApp"></span><div ui-view></div>');
            element = $compile(elem)($rootScope.$new());
        }));
